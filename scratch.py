...
d1 = {"red": {"name":"taylor swift","genre":"horror"}, "attack on tale": {"name":"francis","genre":"action"}, "the life of ty": {"name":"boss philip","genre":"romance"}}  # author
...
def main():
    while True:
        ...
        if x == "display":
            ...
            # display output
            print(f"{i} by {d1[i]['name']} is published in {d2[i]}, the book has {d3[i]} available at {d1[i]['genre']} section")
        elif x == "add":
            print("Add new Booke")
